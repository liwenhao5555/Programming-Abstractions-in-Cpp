 ...
 * Type: Node
 * ----------
 * This structure is a model for types used to represent nodes in a
 * graph.  Clients who wish to create their own node classes should use
 * this structure as a model instead of trying to create an extended
 * subclass.
 */

struct Node {
   std::string name;             /* The name of the node              */
   Set<Arc *> arcs;              /* The set of arcs leaving this node */
};

/*
 * Type: Arc
 * ---------
 * This structure is a model for types used to represent arcs in a
 * graph.  Clients who wish to create their own arc classes should use
 * this structure as a model instead of trying to create an extended
 * subclass.
 */
