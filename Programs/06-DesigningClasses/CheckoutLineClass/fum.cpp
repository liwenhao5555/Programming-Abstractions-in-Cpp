 ...
 * ---------------------------
 * This program duplicates the CheckoutLine program from Chapter 4,
 ...
 * Usage: runSimulation();
 * -----------------------
 * Runs the actual simulation.  In each time unit, the program first
...
/* Instance variables */
   ...
   int nServed;       /* The number of customers served            */
   int totalWait;     /* The total waiting time for the simulation */
   int totalLength;   /* The total queue length for each time step */
